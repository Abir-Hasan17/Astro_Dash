...
public class GamePanel extends JPanel implements ActionListener {
	...
	public void draw_credits(Graphics g) {
		//Cedits:
		g.setColor(new Color(0x3498DB));
		g.setFont( new Font("Ink Free",Font.BOLD, 25));
		FontMetrics metrics4 = getFontMetrics(g.getFont());
		vertical = vertical+g.getFont().getSize()+40;
		g.drawString("Credits:", (SCREEN_WIDTH - metrics4.stringWidth("Credits:"))/2, vertical);

		g.setColor(new Color(0x58D68D));
		g.setFont( new Font("Ink Free",Font.BOLD, 15));
		FontMetrics metrics5 = getFontMetrics(g.getFont());
		vertical = vertical+g.getFont().getSize()+20;
		g.drawString("Game Developer: MD. Abir Hasan", (SCREEN_WIDTH - metrics5.stringWidth("Game Developer: MD. Abir Hasan"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+20;
		g.drawString("Game Designer: MD. Abir Hasan", (SCREEN_WIDTH - metrics5.stringWidth("Game Designer: MD. Abir Hasan"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+20;
		g.drawString("Programmer: MD. Abir Hasan", (SCREEN_WIDTH - metrics5.stringWidth("Programmer: MD. Abir Hasan"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+20;
		g.drawString("Artist: MD. Abir Hasan", (SCREEN_WIDTH - metrics5.stringWidth("Artist: MD. Abir Hasan"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+20;
		g.drawString("Level Designer: MD. Abir Hasan", (SCREEN_WIDTH - metrics5.stringWidth("Level Designer: MD. Abir Hasan"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+20;
		g.drawString("Sound Designer: MD. Abir Hasan", (SCREEN_WIDTH - metrics5.stringWidth("Sound Designer: MD. Abir Hasan"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+20;
		g.drawString("Q&A Testers:", (SCREEN_WIDTH - metrics5.stringWidth("Q&A Testers:"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+10;
		g.drawString("MD. Hasibur Rahman", (SCREEN_WIDTH - metrics5.stringWidth("MD. Hasibur Rahman"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+10;
		g.drawString("MD. Jisan Sarkar", (SCREEN_WIDTH - metrics5.stringWidth("MD. Jisan Sarkar"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+20;
		g.drawString("Special Thanks:", (SCREEN_WIDTH - metrics5.stringWidth("Special Thanks:"))/2, vertical);
		vertical = vertical+g.getFont().getSize()+10;
		g.drawString("BRO CODE", (SCREEN_WIDTH - metrics5.stringWidth("BRO CODE"))/2, vertical);
	}
